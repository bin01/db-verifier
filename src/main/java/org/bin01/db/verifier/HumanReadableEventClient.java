...
public class HumanReadableEventClient extends AbstractEventClient {
  ...
  public <T> void postEvent(T event) throws IOException {
    VerifierQueryEvent queryEvent =
        Types.checkType((Object) event, VerifierQueryEvent.class, "event");
