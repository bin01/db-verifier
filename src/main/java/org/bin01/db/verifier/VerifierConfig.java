...
public class VerifierConfig {
  private String testJdbcDriverMavenCoordinates;
  private String controlJdbcDriverMavenCoordinates;
  ...
  private String queriesJsonPath;
  ...
  private String localRepository = String.format("%s/%s", System.getProperty("user.home"),
      ".m2/repository");
  private List<String> remoteRepositories = ImmutableList.of("http://repo1.maven.org/maven2/");

  @NotNull
  public String getTestJdbcDriverMavenCoordinates() {
    return testJdbcDriverMavenCoordinates;
  }

  @ConfigDescription("Maven coordinates for the Test JDBC Driver")
  @Config("test-jdbc-driver-maven-coordinates")
  public VerifierConfig setTestJdbcDriverMavenCoordinates(String testJdbcDriverMavenCoordinates) {
    this.testJdbcDriverMavenCoordinates = testJdbcDriverMavenCoordinates;
    return this;
  }
  
  @NotNull
  public String getControlJdbcDriverMavenCoordinates() {
    return controlJdbcDriverMavenCoordinates;
  }

  @ConfigDescription("Maven coordinates for the Control JDBC Driver")
  @Config("control-jdbc-driver-maven-coordinates")
  public VerifierConfig setControlJdbcDriverMavenCoordinates(String controlJdbcDriverMavenCoordinates) {
    this.controlJdbcDriverMavenCoordinates = controlJdbcDriverMavenCoordinates;
    return this;
  }
  ...
  @ConfigDescription("Test JDBC Driver name")
  @Config("test-jdbc-driver-name")
  ...
  @ConfigDescription("Control JDBC Driver name")
  @Config("control-jdbc-driver-name")
  ...
  @NotNull
  public String getQueriesJsonPath() {
    return queriesJsonPath;
  }

  @ConfigDescription("Database to fetch query suites from")
  @Config("query-json-path")
  public VerifierConfig setQueriesJsonPath(String queriesJsonPath) {
    this.queriesJsonPath = queriesJsonPath;
    return this;
  }
  ...
  @ConfigDescription("Flag to use current classloader for loading external dependencies")
  @Config("search-current-classloader")
  public VerifierConfig setSearchCurrentClassLoader(boolean searchCurrentClassLoader) {
  ...
  @ConfigDescription("Path to local maven repo")
  @Config("local-repository")
  public VerifierConfig setLocalRepository(String localRepository) {
  ...
  @ConfigDescription("List of remote maven repositories")
  @Config("remote-repositories")
  public VerifierConfig setRemoteRepositories(List<String> remoteRepositories) {
