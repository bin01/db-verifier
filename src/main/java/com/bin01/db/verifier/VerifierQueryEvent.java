...
public class VerifierQueryEvent {
  ...
  public VerifierQueryEvent(String suite, String runId, String source, String name, boolean failed,
      String testCatalog, String testSchema, String testQuery, Double testCpuTimeSecs,
      Double testWallTimeSecs, String controlCatalog, String controlSchema, String controlQuery,
      Double controlCpuTimeSecs, Double controlWallTimeSecs, String errorMessage) {
    this.suite = suite;
    this.runId = runId;
    this.source = source;
    this.name = name;
